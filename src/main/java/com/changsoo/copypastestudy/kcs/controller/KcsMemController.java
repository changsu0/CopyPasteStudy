...
public class KcsMemController {
    ...
    public String kcsMemForm(Model model, KcsMemVO kcsMemVO){
        ...
        model.addAttribute( "chk", aseCommDtService.selectAseCommDtList(aseCommDtVO) );

        aseCommDtVO = new AseCommDtVO();
        aseCommDtVO.setCommCd("kcs_rdo");
        model.addAttribute( "rdo", aseCommDtService.selectAseCommDtList(aseCommDtVO) );
