...
<form:form action="/aseCommCdList" method="get">
...
<br /><br />
    <table class="table table-striped">
        ...
        <tbody>
            <c:forEach var="list" items="${aseCommCdList}" varStatus="status">
                <tr>
                    <td scope="row"><c:out value="${status.count}" /></td>
                    <td><a href="<c:url value='/aseCommCdForm?commCd=${list.commCd}' />">${list.commCd}</a></td>
                    <td>${list.commNm}</td>
                    <td>${list.commDesc}</td>
                </tr>
            </c:forEach>
