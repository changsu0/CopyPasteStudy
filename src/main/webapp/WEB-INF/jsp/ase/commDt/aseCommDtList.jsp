...
<h3>ASE COMM CD LIST</h3>
<br />

<form:form action="/aseCommDtList" method="get">
    <div class="form-row align-items-center">
        ...
        <div class="col-auto">
            ...
            <div class="input-group mb-2">
                ...
                <input type="text" class="form-control" id="commDtCd" placeholder="상세코드" name="commDtCd" value="${aseCommDtVO.commDtCd}">
            </div>
        </div>
        <div class="col-auto">
            ...
            <div class="input-group mb-2">
                ...
                <input type="text" class="form-control" id="commDtNm" placeholder="상세코드명" name="commDtNm" value="${aseCommDtVO.commDtNm}">
            </div>
        </div>
        <div class="col-auto">
            ...
            <div class="input-group mb-2">
                ...
                <input type="text" class="form-control" id="commDtDesc" placeholder="상세코드설명" name="commDtDesc" value="${aseCommDtVO.commDtDesc}">
            </div>
        </div>
        <div class="col-auto">
            ...
            <div class="input-group mb-2">
                ...
                <input type="text" class="form-control" id="commDtGrp" placeholder="상세코드그룹" name="commDtGrp" value="${aseCommDtVO.commDtGrp}">
            </div>
        </div>
        <div class="col-auto">
...
<br /><br />
    <table class="table table-striped">
        ...
        <tbody>
            <c:forEach var="list" items="${aseCommDtList}" varStatus="status">
                <tr>
                    <td scope="row"><c:out value="${status.count}" /></td>
                    <td>${list.commCd}</td>
                    <td><a href="<c:url value='/aseCommDtForm?commDtCd=${list.commDtCd}&commCd=${list.commCd}' />">${list.commDtCd}</a></td>
                    <td>${list.commDtNm}</td>
